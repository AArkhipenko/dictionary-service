...
using Controller = Dictionary.Service.API.Controllers.V10.AuthExampleController;

namespace Dictionary.Service.API.Tests.Controllers.V10.AuthExampleController
{
	/// <summary>
